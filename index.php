...
$productsPagination = $productModel->getAllProductsPagination($pagination::$page, $pagination::$perPage);
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="section__title--2 text-center">
                            <h2 class="title__line">Feature Product </h2>
                            <p></p>
                        </div>
                    </div>
                </div>
                <div class="htc__product__container">
                    <div class="row">
                        <div class="product__list clearfix mt--30">
                            ...
                            <?php if (count($productsPagination) == 0) echo "Không tìm thấy sản phẩm nào !"; ?>
                            <?php foreach ($productsPagination as $product) { ?>
                        ...
                        <div class="col-sm-12" style="display: flex; justify-content: center;">
                            <ul class="pagination">
                                ...
                                if ($previous > 0) {
                                ?>
                                    <li><a href="<?php echo "$url?page=$previous" ?>">
                                            <<</a> </li> <?php } ?> <?php echo $pagination->paginate("$url?", count($products)); ?> <?php
                                                                                                                                    $next = $pagination::$page + 1;
                                                                                                                                    if ($pagination::$page < count($products) / $pagination::$perPage) {
                                                                                                                                    ?> <li><a href="<?php echo "$url?page=$next" ?>">>></a></li><?php } ?>
                            </ul>
                        </div>
                    </div>
                </div>
