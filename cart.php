                                        ...
                                        foreach ($carts as $cart) { ?>
                                            <tr>
                                                ...
                                                <td class="product-quantity">
                                                    <a class="tanggiam" href="handlingCart.php?id_giam=<?php echo $cart['id_product']; ?>">-</a>
                                                    <input type="number" value="<?php echo $cart['amount_product'] ?>" disabled />
                                                    <a class="tanggiam" href="handlingCart.php?id_tang=<?php echo $cart['id_product']; ?>">+</a>
                                                </td>
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="buttons-cart--inner">
                                        ...
                                        <div class="buttons-cart">
                                            <a href="FullOrdersUsername.php">Review orders</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-6 col-sm-12 col-xs-12 smt-40 xmt-40">
                                    <div class="htc__cart__total">
                                        ...
                                        <ul class="payment__btn">
                                            <li class="active"><a href="handlingCart.php?username=<?php echo $_SESSION['username']; ?>">payment</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
